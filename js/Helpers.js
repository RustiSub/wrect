(function() {
    "use strict";
    window.Helpers = window.Class.extend({
        init: function() {
            // compatibility
            this.merge = this.object.merge;
            this.copy = this.object.copy;
            this.getFunctionFromString = this.function.getFunctionFromString;
        },
        object: {
